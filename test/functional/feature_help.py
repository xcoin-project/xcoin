...
"""Verify that starting xcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xcoin with -h for help text")
        ...
        self.log.info("Start xcoin with -version for version information")
        ...
        self.log.info("Start xcoind with -fakearg to make sure it does not start")
