...
xcoin.conf        | contains configuration settings for xcoind or xcoin-qt
xcoind.pid        | stores the process id of xcoind while running
...
debug.log           | contains debug information and general logging generated by xcoind or xcoin-qt
