Xcoin Core version *0.15.1* is now available from:

  <https://download.xcoin.org/xcoin-0.15.1/>
...
A number of changes to the way Xcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 quarks per kB (0.00001 PYM). This is to prepare for dropping the minimum transaction fee to 0.1 quarks per kB (0.0001 PYM) in the next release.
