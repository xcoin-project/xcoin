# Support for Output Descriptors in Xcoin Core

Since Xcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `pym1...` for mainnet or `tpym1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Xcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Xcoin Core wallets, a convenience function `combo` is
